...
def preprocess_data(df_data):
    ...
    unique_tags = np.unique(np.concatenate(df_data['house_tag'].str.split('/')))
    print(unique_tags)
    ...
    df_data['house_floor'] = df_data['house_floor'].apply(lambda x: process_floor(x))
